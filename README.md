...
To build the J1Sc, you need first to create the VDHL / Verilog sources. The implementation is written by using *Spinal HDL* (https://github.com/SpinalHDL/SpinalHDL). Hence these sources are generated by a Scala program (Spinal HDL is a compelling Scala library which can be used to generate VHDL and Verilog code.).

* Install OpenJDK 8

* Install a running Scala system and sbt

* Clone the latest version of Spinal HDL (at least version 1.3.6)
