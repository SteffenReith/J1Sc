...
set_property  PACKAGE_PIN T16 [get_ports {pButtons[0]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {pButtons[0]}]

set_property  PACKAGE_PIN R10 [get_ports {pButtons[1]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {pButtons[1]}]

set_property  PACKAGE_PIN F15 [get_ports {pButtons[2]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {pButtons[2]}]

set_property  PACKAGE_PIN V10 [get_ports {pButtons[3]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {pButtons[3]}]

set_property  PACKAGE_PIN E16 [get_ports {pButtons[4]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {pButtons[4]}]

set_property  PACKAGE_PIN U9 [get_ports {sSwitches[0]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[0]}]

set_property  PACKAGE_PIN U8 [get_ports {sSwitches[1]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[1]}]

set_property  PACKAGE_PIN R7 [get_ports {sSwitches[2]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[2]}]

set_property  PACKAGE_PIN R6 [get_ports {sSwitches[3]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[3]}]

set_property  PACKAGE_PIN R5 [get_ports {sSwitches[4]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[4]}]

set_property  PACKAGE_PIN V7 [get_ports {sSwitches[5]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[5]}]

set_property  PACKAGE_PIN V6 [get_ports {sSwitches[6]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[6]}]

set_property  PACKAGE_PIN V5 [get_ports {sSwitches[7]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[7]}]

set_property  PACKAGE_PIN U4 [get_ports {sSwitches[8]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[8]}]

set_property  PACKAGE_PIN V2 [get_ports {sSwitches[9]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[9]}]

set_property  PACKAGE_PIN U2 [get_ports {sSwitches[10]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[10]}]

set_property  PACKAGE_PIN T3 [get_ports {sSwitches[11]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[11]}]

set_property  PACKAGE_PIN T1 [get_ports {sSwitches[12]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[12]}]

set_property  PACKAGE_PIN R3 [get_ports {sSwitches[13]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[13]}]

set_property  PACKAGE_PIN P3 [get_ports {sSwitches[14]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[14]}]

set_property  PACKAGE_PIN P4 [get_ports {sSwitches[15]}]
set_property  IOSTANDARD LVCMOS33 [get_ports {sSwitches[15]}]
